...
- `toDt` now parses all-numeric dates with two digit years like `12/16/25` as month/day/year,
  matching the four digit year case. Previously it was read as year 2012, month 16,
  and silently normalized to `2013-04-25`.
