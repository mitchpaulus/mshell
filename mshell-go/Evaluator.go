...
func (state *EvalState) Evaluate2(objects []MShellParseItem, stack *MShellStack, context ExecuteContext, definitions []MShellDefinition) EvalResult {
    index := 0
    ...
    for index < len(objects) {
        ...
        case *MShellParseList:
            ...
            result := state.Evaluate2(list.Items, &listStack, context, definitions)
        ...
        case *MShellParseQuote:
            ...
            q := MShellQuotation2 { Objects: parseQuote.Items, StandardInputFile: "", StandardOutputFile: "", StandardErrorFile: "" }
            stack.Push(&q)
        case Token:
            t := t.(Token)
